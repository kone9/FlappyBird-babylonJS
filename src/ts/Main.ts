...
import{Pajaro} from "./Pajaro";//importo librería Pajaro que heredo de objetoRigidbody
...
function CrearEscenaPrincipal(engine:BABYLON.Engine,canvas:HTMLElement):BABYLON.Scene //retorna la escena tomo como parametro el motor
    ...
    let onGameOver = new BABYLON.Observable();//incia un observable de tipo puedo reiniciar cuando es GameOver buscar info sobre observables en babylon
    let onIniciar = new BABYLON.Observable();
    ...
    BABYLON.SceneLoader.Append("./babylonExportBlender/", "Escenario.babylon", scene,
        ...
        function (scene: BABYLON.Scene) {
            ...
            //////////////////////////////////////////////////////////////////////////////////////////////////
            onIniciar.notifyObservers(true);//"OBSERVADOR PERSONALIZADO"//notifica verdadero cuando inicio la escena 
            ...
            pajaro.maestroFisico.onCollideEvent= (collider, collidedWith) => {
                ...
                if (BABYLON.Tags.GetTags(collidedWith) === "obstaculo") {
                    ...
                    onGameOver.notifyObservers(puedoReinciar);//cuando llego aqui notifico que es game over
    ...
    ////////INTERFACE//////////INTERFACE///////////INTERFACE////////////////////INTERFACE
     ///CREATE BUTTON
    onGameOver.addOnce(function(gameOver:unknown) { //observable personalizado si es GameOver
...
function CrearMenu(engine:BABYLON.Engine,canvas:HTMLCanvasElement):BABYLON.Scene
{
    ...
    //observadores personalizados
    let onGameOver = new BABYLON.Observable();//incia un observable de tipo puedo reiniciar
    let onIniciar = new BABYLON.Observable();
