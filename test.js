...
var MotorRenderizado //esta clase construye al motor es la encargada de tener el bucle para renderizar
 = /** @class */ (function () {
    function MotorRenderizado() {
        this.canvas = document.getElementById("renderCanvas"); //busco el elemento render canvas
        this.engine = new BABYLON.Engine(this.canvas, true); // Generate the BABYLON 3D engine
    }
    Object.defineProperty(MotorRenderizado.prototype, "canvas", {
        get: function () {
            return this._canvas;
        },
        set: function (value) {
    ...
    Object.defineProperty(MotorRenderizado.prototype, "engine", {
        get: function () {
            return this._engine;
        },
        set: function (value) {
    ...
    return MotorRenderizado;
}());
var EscenaPrincipal //clase que crea las partes principales de escenario
 = /** @class */ (function () {
    function EscenaPrincipal() {
        this._gameOver = false;
    }
    Object.defineProperty(EscenaPrincipal.prototype, "gameOver", {
        get: function () {
    ...
    EscenaPrincipal.prototype.Escena1 = function (engine, canvas) {
        ...
        var botonReiniciar = new UIBotones();
...
var UIBotones = /** @class */ (function () {
    function UIBotones() {
    }
    UIBotones.prototype.BotonReiniciarScene = function (scene) {
...
var ManejarEscenas = /** @class */ (function () {
    function ManejarEscenas() {
        ...
        function Escena1(engine, canvas) {
            var scene = new BABYLON.Scene(engine); //crea la escena
            scene.enablePhysics(new BABYLON.Vector3(0, -9.81, 0), new BABYLON.CannonJSPlugin());
            var gameOver = false;
            //muestro el editor
    ...
    return ManejarEscenas;
}());
/////Esto es para inicializar el motor
var _ManejarEscenas = new ManejarEscenas(); //instancio la escena principal
